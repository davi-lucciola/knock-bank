...
def get_all_transactions(transaction_query: TransactionQueryDTO):
    '''
...
def withdraw_money(transaction_dto: TransactionDTO):
...
@transaction_bp.input(TransactionIn, arg_name='transaction_dto')
@transaction_bp.auth_required(auth)
def deposit_money(transaction_dto: TransactionDTO):
...
def transfer_money(transaction_transfer_dto: TransactionTransferDTO):
